...
export default function RightSidebar({ isOpen, onClose }: RightSidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed right-0 top-0 z-50 h-full w-80 flex-shrink-0 overflow-y-auto bg-white shadow-2xl transition-transform duration-300 dark:border-gray-800 dark:bg-gray-900 lg:sticky lg:top-0 lg:h-screen lg:translate-x-0 lg:shadow-none",
